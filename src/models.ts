...
export const DEFAULT_MODELS: ModelOption[] = [
  ...
  { id: "gemini-3.5-flash-high", label: "Gemini 3.5 Flash (High)", maxContextWindow: 1_000_000 },
  { id: "gemini-3.5-flash-medium", label: "Gemini 3.5 Flash (Medium)", maxContextWindow: 1_000_000 },
  { id: "gemini-3.5-flash-low", label: "Gemini 3.5 Flash (Low)", maxContextWindow: 1_000_000 },
