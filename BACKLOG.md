...
- [~] **PR #52 (RFC #49 / Issue #10)** : Gestion du cycle de vie asynchrone des sous-agents et auto-notification Telegram (Option 1 : Auto-polling passerelle avec qualification des tours suspensifs, réveil accéléré sur fichiers de messages internes, backoff progressif, délivrance autonome de la synthèse finale avec télémétrie post-prompt et résilience aux redémarrages). *(Pull Request soumise vers upstream/main)*
  - Pull Request : https://github.com/ardiannurcahya/antigravity-cli-telegram-bot/pull/52
  - RFC amont associée : https://github.com/ardiannurcahya/antigravity-cli-telegram-bot/issues/49
  - Issue privée : https://github.com/Homeboyz-IT/agy-telegram-private/issues/10
  - Spécification : `docs/specs/subagent-async-lifecycle-notification.md`
