...
- [~] **PR #38** : Nettoyage des mentions résiduelles d'« Option A » dans le `README.md` ([PR #38](https://github.com/ardiannurcahya/antigravity-cli-telegram-bot/pull/38), [Issue #6](https://github.com/LeMeD/agy-telegram-private/issues/6), [Spécifications](docs/specs/per-session-workspace-isolation.md)). *(Soumise et en attente de revue dans upstream/main)*
...
- [~] **Nettoyage des mentions résiduelles d'« Option A » (README et tests)** : Suppression des références à l'ancienne désignation « Option A » au profit du modèle standard nominal du bot ([Issue #6](https://github.com/LeMeD/agy-telegram-private/issues/6), [PR #38](https://github.com/ardiannurcahya/antigravity-cli-telegram-bot/pull/38), [Spécifications](docs/specs/per-session-workspace-isolation.md)).
